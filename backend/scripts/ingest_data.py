...
def fetch_exchanges():
    resp = requests.get(COINGECKO_URL, headers=HEADERS)
...
def map_api_to_exchange(api_data, country_id):
    return {
        ...
        "reviews_page_content": None,
        "has_copy_trading": None,
        "has_staking": None,
        "has_futures": None,
        "has_spot_trading": None,
        "has_demo_trading": None,
        "trading_volume_24h": api_data.get("trade_volume_24h_btc")*107500,
        "spot_maker_fee": None,
        "futures_maker_fee": None,
        "spot_taker_fee": None,
        "futures_taker_fee": None,
        "fee_structure_summary": None,
        "security_details": None,
        "kyc_aml_policy": None,
        "liquidity_score": None,
        "newbie_friendliness_score": None,
        "registration_country_id": country_id,
        "headquarters_country_id": None,
    }
